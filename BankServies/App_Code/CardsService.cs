...
{
	private OleDbConnection objConn;//כניסה לבסיס הנתונים
	private OleDbCommand objCmd;//פקודה לבסיס הנתונים
	private OleDbTransaction objTrans;//מבצע טרנזציה
	private string connectionString;//סטרינג קישור  להסיס נתונים
